...
class ShowMini : BaseItem() {
    private val label = JCheckBox("显示报警按钮", deploy.config.getBoolean("显示报警图标", true));
    ...
    override fun save(config: Config) {
        config.set("显示报警图标", label.isSelected)
    }
